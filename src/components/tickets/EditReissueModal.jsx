    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 py-6" onMouseDown={handleBackdrop}>
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl flex flex-col max-h-[90vh]">
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
          <h2 className="text-lg font-semibold text-gray-900">Edit Reissue Details</h2>
        ...
        <div className="overflow-y-auto flex-1 px-6 py-5">
          ...
          <form id="edit-reissue-form" onSubmit={handleSubmit} className="space-y-3">
            ...
            <p className="text-xs text-gray-400">Prices recompute live from the fields below</p>
