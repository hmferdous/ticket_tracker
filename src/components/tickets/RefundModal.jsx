            ...
            {(mode === "initiate" || mode === "edit") && (
              <>
                ...
                <div>
                  ...
                  {ticket && (
                    <p className={`mt-1 text-xs font-medium ${previewNet > 0 ? "text-red-600 dark:text-red-400" : previewNet < 0 ? "text-orange-600 dark:text-orange-400" : "text-emerald-600 dark:text-emerald-400"}`}>
