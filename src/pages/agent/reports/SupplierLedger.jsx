        ...
        {generated && (
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
              ...
              <SummaryCard label="Total Paid" value={`${fmt(summary.totalPaid)} BDT`} accent="text-green-600" />
              <SummaryCard label="Total Refunded" value={`${fmt(summary.totalRefunded)} BDT`} accent="text-orange-600" />
              <SummaryCard
                label="Net Payable"
                value={`${fmt(summary.netPayable)} BDT`}
                accent={summary.netPayable > 0 ? "text-red-600" : "text-green-600"}
              />
              <SummaryCard label="Unallocated" value={`${fmt(summary.unallocated)} BDT`} accent="text-blue-600" />
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
              {openingBalance !== null && (
                <div className="flex items-center justify-between px-4 py-3 bg-gray-50 border-b border-gray-200">
                  ...
                  <span className={`text-sm font-semibold tabular-nums ${openingBalance > 0 ? "text-red-600" : openingBalance < 0 ? "text-green-600" : "text-gray-500"}`}>
